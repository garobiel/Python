#Faça um programa que leia um número inteiro qualquer e mostre na tela a sua tabuada, quando for ver estrutara de repitcao ira ver
n1= int(input('Dige um nuemro: '))
